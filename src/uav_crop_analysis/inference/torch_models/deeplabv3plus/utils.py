...
# Muc dich: cung cap helper lay layer trung gian va module segmentation chung.
# Dau vao: model backbone va danh sach layer can tra ve.
# Dau ra: OrderedDict feature map dung cho head DeepLab.
