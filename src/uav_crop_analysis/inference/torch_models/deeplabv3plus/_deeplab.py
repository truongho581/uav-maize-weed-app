...
# Muc dich: dinh nghia head va wrapper DeepLabV3/DeepLabV3+.
# Dau vao: feature map tu backbone, low-level feature va so lop.
# Dau ra: logits segmentation duoc noi suy ve kich thuoc anh dau vao.
