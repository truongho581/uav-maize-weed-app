...
# Muc dich: tao cac ham khoi tao DeepLabV3+ voi backbone ResNet.
# Dau vao: so lop, output stride va tuy chon pretrained backbone.
# Dau ra: model DeepLabV3+ san sang train/inference segmentation.
...
def _load_model(arch_type, backbone, num_classes, output_stride, pretrained_backbone):
  ...
  return _segm_resnet(
      arch_type, backbone, num_classes, output_stride=output_stride,
